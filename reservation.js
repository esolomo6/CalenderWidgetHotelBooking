$(document).ready(function() {
    ...
    //jscript to implement the tabs widgit
    $('#tabs').tabs();


    //jscript to implement the datepicker widgit
    //sets the min date to current date and max date to +90days
    ...
    //event handler on click to display policies as a dialog
